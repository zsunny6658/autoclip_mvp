...
app = FastAPI(
    title="Simple API",
    description="简化版API (已移除 bilitool 相关功能)",
    version="1.0.0"
)
...
async def root():
    """根路径"""
    return {"message": "Simple API (bilitool功能已移除)", "version": "1.0.0"}
...
if __name__ == "__main__":
    print("🚀 启动简化版API服务器 (已移除 bilitool 相关功能)...")
